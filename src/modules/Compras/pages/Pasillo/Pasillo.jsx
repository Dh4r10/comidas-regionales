        ...
        <table className="table-auto w-full">
          <thead>
            <tr className="border-b-2 border-[#009444] dark:border-[#98aaae]">
              ...
              <th className="px-4 py-2 w-32 text-left">NOM. ALMACEN</th>
              <th className="px-4 py-2 w-28 text-left">NÚMERO PASILLO</th>
              <th className="px-4 py-2 w-32 text-left">NOMBRE</th>
              <th className="px-4 py-2 w-60 text-left">DESCRIPCIÓN</th>
          ...
          <tbody className="table-group-divider">
            <tr className="border-b-2 border-[#009444] dark:border-[#98aaae]">
              ...
              <td className="px-4 py-2 w-32 text-sm">Almacen 2</td>
              <td className="px-4 py-2 w-28 text-sm">110</td>
              <td className="px-4 py-2 w-32 text-sm">LEGUMBRES</td>
              <td className="px-4 py-2 w-60 text-sm">
                ACA SE ENCUENTRAN LAS LEGUMBRES
              </td>
